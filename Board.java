...
/**
 * Board class: creates a board with the secret phrase and what the player has
 * solved so far
...
public class Board {
   ...
   *              Pre-condition: loadPhrase() and setLetterValue() are properly
   *              declared and written,
   *              instance variables are properly declared
   *              Post-condition: solvedPhrase, phrase, and currentLetterValue are
   *              initialized and
   ...
   *              Pre-condition: method call is assigned to variable or printed,
   *              phrase is properly declared
   ...
   *              Post-condition: currentLetterValue is set to a random value each
   ...
   * @return boolean
   * @throws none
   *              Checks if the phrase is the same as the guess passed to the
   *              method
   *              Pre-condition: method call is assigned to variable or printed,
   *              phrase and guess are
   ...
   *                 Pre-condition: method call is assigned to variable or
   *                 printed, solvedPhrase is properly
   *                 declared, phrase.txt exists
   *                 Post-condition: a random String from the text file is
   *                 returned to method call
   */
   ...
   *         Pre-condition: method call is assigned to variable or printed,
   *         solvedPhrase and phrase are properly declared
   *         Post-condition: true or false is returned to the method call,
   *         solvedPhrase is set to a new
   ...
   *         solvedPhrase and phrase are properly declared
   *         Post-condition: true or false is returned to the method call,
   *         solvedPhrase is set to a new phrase that contains the secret phrase
   */
